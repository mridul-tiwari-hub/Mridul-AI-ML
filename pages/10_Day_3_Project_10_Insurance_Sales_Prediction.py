...
data_path = os.path.join(root_dir, "data", "insurance_data.csv")

if not os.path.exists(data_path):
    st.error(f"Error: {data_path} not found. Please ensure insurance_data.csv is placed in the data/ folder.")
else:
