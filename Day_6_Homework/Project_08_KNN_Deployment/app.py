...
@st.cache_resource
def load_knn_model():
    model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "knn_iris_model.pkl")
...
st.title("🌸 Iris Flower Classifier (KNN Deployment)")
st.write("Enter the sepal and petal dimensions below to predict the flower species using the K-Nearest Neighbors (KNN) model.")
